...
test_that("description extract works", {
  ...
  expect_named(num, c("doc_id", "text", "description"))
...
test_that("claims extract works", {
  ...
  expect_named(num, c("doc_id", "text", "claims"))

})

test_that("tac extract works", {
  num <- derwent_extract(five_texts, "text", section = "tac")
  expect_named(num, c("doc_id", "text", "number", "title", "abstract", "claims"))
...
test_that("full extract works", {
  ...
  expect_named(num, c("doc_id", "text", "number", "title", "abstract", "description", "claims"))
